...
<%
	...
	pageContext.setAttribute("area", area);//자바코드의 배열을 쓰기위해서 .
%>
<!-- *.tv요청 
...
<form:form commandName="td"  method="post"  action="update.tv">
	<input type="hidden" name="num" id="num" value="${travel.num }">
	<input type="hidden" name="pageNumber" id="num" value="${pageNumber}">
	...
	<p>
		...
		<label for="area">관심지역(${travel.area})</label>
		<%-- area 갯수 : ${fn:length(area)-1 } --%>
